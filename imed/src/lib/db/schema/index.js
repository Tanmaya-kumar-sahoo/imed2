...
__exportStar(require("./medicines"), exports);
__exportStar(require("./users"), exports);
// Export schema for Drizzle migration tools
var medicineSchema = require("./medicines");
var userSchema = require("./users");
var patientSchema = require("./patients");
// Make sure all tables are properly exported
exports.schema = __assign(__assign(__assign({}, medicineSchema), userSchema), patientSchema);
